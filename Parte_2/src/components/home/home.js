      ...
      <Card>
        <div>
          ...
          <p>Nosso curso é focado em aprimorar os conhecimentos dos nossos alunos com o auxílio de diversos 
            ...
            curso serão os Flashcards, método de estudo que auxilia na memorização por meio de cartões respostas, ajudando a fixar o conteúdo de forma mais dinâmica.</p>
          <br/>
          <p><b>Modalidades</b></p>
          <p>Os alunos podem escolher entre as modalidades presencial, Online (Ead) ou híbrida, proporcionando-lhes a escolha do modo de ensino que preferirem.
          </p>
        </div>
      </Card>
      <h5 className="subtitle">Qualificações</h5>
        ...
        <Experience title="Nota do MEC"
          description="A qualidade dos nossos cursos é comprovada através de nossa nota no MEC, 
            tendo nota 5, servindo como medida para futuros alunos que venham a aderir nossos cursos"
        ...
        <Experience title="Plataforma online"
          description="Possuimos uma plataforma online feita para atender todas as necessidades dos alunos,
            permitindo um aprendizado mais dinâmico e com interação direta com os professores e orientadores"
